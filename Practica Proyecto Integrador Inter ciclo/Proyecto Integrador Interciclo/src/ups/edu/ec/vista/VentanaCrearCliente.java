...
public class VentanaCrearCliente extends javax.swing.JInternalFrame {
    ...
    public void cargarCodigo() {
        txtCodigo.setText(String.valueOf(controladorCliente.generarCodigo()));
    }
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (nombre.isBlank() || apellido.isBlank() || cedula.isBlank() || fechaNacimiento == null
            ...
            if (controladorCliente.update(cliente, cliente)) {
    ...
    private void tblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientesMouseClicked
        ...
        jDateChooser1.setCalendar(cliente.getFechaNacimiento());
