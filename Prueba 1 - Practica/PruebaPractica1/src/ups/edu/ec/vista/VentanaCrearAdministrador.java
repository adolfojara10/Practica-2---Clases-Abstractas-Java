 ...
 * @author User
 */
public class VentanaCrearAdministrador extends javax.swing.JInternalFrame {

    private ControladorAdministrador controladorAdministrador;

    /**
     * Creates new form VentanaCrearAdministrador
     */
    public VentanaCrearAdministrador(ControladorAdministrador controladorAdministrador) {
        initComponents();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnCrear, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if (nombre.isBlank() || apellido.isBlank() || cedula.isBlank() || fechaNacimiento == null || genero.equals("--Seleccione--")
            ...
            try {
                ...
                if (controladorAdministrador.create(admin)) {
