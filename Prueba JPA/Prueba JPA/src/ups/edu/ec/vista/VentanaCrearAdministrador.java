...
public class VentanaCrearAdministrador extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaCrearAdministrador(ControladorAdministrador controladorAdministrador, String keyUnlock) {
        initComponents();
    ...
    public void cargarCodigo() {
        txtCodigo.setText(String.valueOf(controladorAdministrador.getCodigo() + 1));
    }
    ...
    public void llenarTblAdministradores() {
        ...
        for (Administrador admin : (List<Administrador>) controladorAdministrador.findAll()) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtFormattedTelefono, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if (nombre.isBlank() || apellido.isBlank() || cedula.isBlank() 
    ...
    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        ...
        //administrador.setCedula(cedula);
        administrador = (Administrador) controladorAdministrador.findByCedula(cedula);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (nombre.isBlank() || apellido.isBlank() || cedula.isBlank()
            ...
            if (controladorAdministrador.update(administrador)) {
