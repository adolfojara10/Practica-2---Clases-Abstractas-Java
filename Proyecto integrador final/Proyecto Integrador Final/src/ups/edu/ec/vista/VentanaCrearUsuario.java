...
public class VentanaCrearUsuario extends javax.swing.JInternalFrame {
    ...
    public void cargarCodigo() {
        txtCodigo.setText(String.valueOf(controladorAdministrador.getLongitud() + 1));
    }
    ...
    public void llenarTblAdministradores() {
        ...
        for (Administrador admin : (List<Administrador>) controladorAdministrador.findAll()) {
            ...
            if (admin.getTipo().equalsIgnoreCase(EnumTipoAdministrador.SIMPLE.toString())) {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if (nombre.isBlank() || apellido.isBlank() || cedula.isBlank() || fechaNacimiento == null
            ...
            if (controladorAdministrador.validarEmail(email)) {
                ...
                administrador.setTipo(EnumTipoAdministrador.SIMPLE.toString());
    ...
    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        ...
        String passwordDesencriptado = controladorAdministrador.desencriptarPassword(keyUnlock, administrador.getContrasenia());
        ...
        jDateChooser1.setDate(administrador.getFechaNacimiento());
