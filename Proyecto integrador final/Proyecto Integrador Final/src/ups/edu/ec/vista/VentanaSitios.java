...
public class VentanaSitios extends javax.swing.JInternalFrame {
    ...
    public void filtrarSitios(EnumEstadoSitio enumEstadoSitio) {
        var listaSitio = (List<Sitio>) controladorSitio.findAll();
        ...
        int codigoSitio = controladorSitio.findAll().size() - 1;
        ...
        while (codigoSitio >= 0) {
            ...
            if (sitio.getEstado().equalsIgnoreCase(enumEstadoSitio.toString())) {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        sitioNuevo.setCodigo(controladorSitio.findAll().size() + 1);
        sitioNuevo.setEstado(EnumEstadoSitio.DESOCUPADO.toString());
        sitioNuevo.setPrecio(BigDecimal.valueOf(0.25));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            sitioEncontrado = (Sitio) controladorSitio.read(codigo);

            if (sitioEncontrado != null && sitioEncontrado.getEstado().equalsIgnoreCase(EnumEstadoSitio.DESOCUPADO.toString())) {
